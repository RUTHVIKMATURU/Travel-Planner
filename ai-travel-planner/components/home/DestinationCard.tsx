...
export default function DestinationCard({
  ...
  return (
    ...
    >
      <Card
        className={cn(
          "group h-full overflow-hidden border-white/70 bg-white/80 p-0 backdrop-blur-xl transition-colors duration-500 hover:border-emerald-200/80 dark:border-white/10 dark:bg-zinc-950/65 dark:hover:border-emerald-800/60",
          radii.card,
          shadows.card,
          shadows.cardHover,
        )}
